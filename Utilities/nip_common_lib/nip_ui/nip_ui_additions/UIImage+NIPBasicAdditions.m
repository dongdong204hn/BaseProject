...
@implementation UIImage(NIPAddtion_Create)
...
@implementation UIImage (NIPAddtion_Alpha)
...
@implementation UIImage (NIPAddtion_Resize)
...
-(UIImage*)rotate:(UIImageOrientation)orient
{
    ...
    return [[UIImage alloc] initWithCGImage:copy.CGImage scale:self.scale orientation:self.imageOrientation];
}

@end

@implementation UIImage (NIPAddtion_RoundedCorner)
...
@implementation UIImage (NIPAddtion_Color)
...
//    LOG(@"The Color is %@  repeats %zd",[MaxColor description],MaxCount);
