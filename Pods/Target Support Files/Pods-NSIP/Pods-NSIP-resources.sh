...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "NIPJSBridge/NIPJSBridge/Assets/api.htm"
  install_resource "NIPJSBridge/NIPJSBridge/Assets/NIPJSBridge.js.txt"
  install_resource "NIPJSBridge/NIPJSBridge/Assets/PluginConfig.json"
