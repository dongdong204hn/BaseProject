...
- (void)getDeviceInfo:(NIPJSInvokedURLCommand *)command{
    ...
    [deviceProperties setObject:[device systemName]
                         forKey:@"systemName"];
    [deviceProperties setObject:[device systemVersion]
                         forKey:@"systemVersion"];
    [deviceProperties setObject:[device model]
                         forKey:@"model"];
    [deviceProperties setObject:[device modelVersion]
                         forKey:@"modelVersion"];
    [deviceProperties setObject:[self uniqueAppInstanceIdentifier]
                         forKey:@"identifier"];
    
    NIPJSPluginResult* pluginResult = [NIPJSPluginResult resultWithStatus:NIPJSCommandStatus_OK
                                                      messageAsDictionary:[NSDictionary dictionaryWithDictionary:deviceProperties]];
...
- (void)getClientInfo:(NIPJSInvokedURLCommand *)command{
    ...
    [clientInfos setObject:[bundleDic objectForKey:@"CFBundleShortVersionString"]
                    forKey:@"appVersion"];
    [clientInfos setObject:[bundleDic objectForKey:@"CFBundleVersion"]
                    forKey:@"appBuild"];
    
    NIPJSPluginResult *pluginResult = [NIPJSPluginResult resultWithStatus:NIPJSCommandStatus_OK
                                                      messageAsDictionary:clientInfos];
    [self.commandDelegate sendPluginResult:pluginResult
                                callbackId:command.callbackId];
}
...
- (void)setScreenStatus:(NIPJSInvokedURLCommand*)command{
    ...
    NIPJSPluginResult* pluginResult = [NIPJSPluginResult resultWithStatus:NIPJSCommandStatus_OK
                                                      messageAsDictionary:[NSDictionary dictionaryWithDictionary:dic_result]];
